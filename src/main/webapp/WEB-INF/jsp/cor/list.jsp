    ...
    <jsp:body>
                    <div class="panel panel-default">
                        <div class="panel-heading clearfix">
                            <a href="${linkTo[CorController].addForm}" class="btn btn-sm btn-primary pull-right" role="button" title="${addTitle}"><span class="glyphicon glyphicon-plus"></span></a>
                        </div>
        <c:choose>
                        ...
                        <table class="table table-hover table-striped table-bordered table-condensed">
                            ...
                            <c:forEach items="${corList}" var="cor" varStatus="row">
                                <tr>
                                    ...
                                    <td>${cor.nome}</td>
                                    <td>
                                        <a href="${linkTo[CorController].editForm(cor.id)}" role="button" title="${editTitle}"><span class="glyphicon glyphicon-pencil"></span></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
            ...
            <c:otherwise>
                        <div class="panel-body">
                            <p>Nenhuma cor cadastrada até o momento.</p>
                        </div>
            </c:otherwise>
        </c:choose>
                    </div>
