jQuery(function($){
    ...
    $("a[href*='pdf'], a[title~='PDF']").attr("target", "_blank");
    $(document).on("click", "a[href='#']", function(e) { e.preventDefault(); });
    $("#modalWindow").on("shown.bs.modal", function()  { $(":text[value='']:first").focus(); });
    //Settings
...
//    var halfPath = fullPath.split("/");
//
//    ((halfPath[2].length === 0) ? $(".sidebar-menu > li > a[href='"+ fullPath +"']").parent().addClass("active")
//                                : $(".sidebar-menu > li > a[href*='"+ halfPath[2] +"']").parent().addClass("active"));
//
//    $(".treeview-menu a[href='"+ fullPath +"']").parent().addClass("active");
//    $(".treeview-menu a[href='"+ fullPath +"']").parents(".treeview").addClass("active");
    //
    ...
    $("input[alt='fone']").mask(PhoneMaskBehavior, phOptions);
    //jQuery Mask Plugin
...
//    });
    ...
    //DataTables//
    var eTable = $("#employeeTable").DataTable({
        language: {
            ...
            infoEmpty         : "Mostrando de 0 at&eacute; 0 de 0 registros",
            infoFiltered      : "(filtrado de _MAX_ registros no total)",
            emptyTable        : "Nenhum registro at&eacute; o momento.",
    ...
    $("#employeeTable_filter").addClass("input-group input-group-sm");
    $("#employeeTable_filter input").unwrap();
    //DataTables//
});